	...
	<div class="span12">
	  <div class="maincontent" style="border:0px;">
		...
		<table class="table table-bordered table-condensed">
		  <tr>
		    <td style="width:50%;">
		      <h3>Dragon Associates</h3>
		    </td>
		    <td style="text-align:center; width:50%; vertical-align:middle;" rowspan="5">
		      <img src="/img/dragon-associates.jpg"/><br/>
		    </td>
		  <tr>
		    <td>
		      <b>Nature of Business:</b> Public relations and strategic advisory<br/>
		    </td>
		  </tr>
		  <tr>
		    <td>
		  ...
		  <tr>
		    <td>
		      <b>Headquarters:</b><br/>3rd Floor, 111 Buckingham Palace Road<br/>London SW1W 0SR (<a href="https://maps.google.com/maps/ms?msid=211049723901618750359.0004c6207d52d536dbe8a&msa=0&ll=51.502545,-0.155697&spn=0.065609,0.154324&iwloc=0004c620837b2949a7e5a">map</a>)
		    </td>
		  </tr>
		  <tr>
		    <td>
		...
		<div class="well">
		  ...
		  <hr/>
		  <p>
		    Unknown, but could be on the same scale as <a href="new-century-media.php">New Century Media</a> which was contracted for &pound;20,000 (approx $31,300) per month.
		  </p>
		</div>
